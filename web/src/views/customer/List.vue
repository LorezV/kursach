                ...
                <table class='w-full text-left'>
                    <thead>
                        <tr class='text-xs border-b'>
                            ...
                            <td class='px-2'>Телефон</td>
                            <td class='px-2'>Адресс</td>
                            <td class='px-2'>Карта</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for='item in store.data'>
                            ...
                            <td class='px-2'>{{ item.address }}</td>
                            <td class='px-2'>{{ item.discountCard || "" }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class='p-2 bg-white' v-else>
                Для того, чтобы покупатели появились, запустите симуляцию.
            </div>
        </div>
    </div>
</template>